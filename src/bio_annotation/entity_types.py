...
ANNOTATOR_ENTITY_TYPE_SPECS: tuple[AnnotatorEntityTypeSpec, ...] = (
    ...
    AnnotatorEntityTypeSpec("flair", "Flair / HunFlair", "Disease", "disease", ("CTD Diseases",)),
    AnnotatorEntityTypeSpec("flair", "Flair / HunFlair", "Chemical / drug", "drug", ("CTD Chemicals",)),
