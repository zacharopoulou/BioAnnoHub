        ...
        rows.append(
            {
                ...
                "strict_norm_any_correct": strict_norm.get("correct"),
                "strict_norm_all_gold_ids_recovered": strict_norm.get("all_gold_ids_recovered"),
                "strict_norm_partially_correct": strict_norm.get("partially_correct"),
                ...
                "strict_norm_any_accuracy_on_matched_spans": strict_norm.get("accuracy_on_matched_spans"),
                "strict_norm_any_accuracy_on_comparable_gold_spans": strict_norm.get("accuracy_on_comparable_gold_spans"),
                "strict_norm_all_gold_ids_accuracy_on_matched_spans": strict_norm.get("all_gold_ids_accuracy_on_matched_spans"),
                "strict_norm_all_gold_ids_accuracy_on_comparable_gold_spans": strict_norm.get("all_gold_ids_accuracy_on_comparable_gold_spans"),
                ...
                "lenient_norm_any_correct": lenient_norm.get("correct"),
                "lenient_norm_all_gold_ids_recovered": lenient_norm.get("all_gold_ids_recovered"),
                "lenient_norm_partially_correct": lenient_norm.get("partially_correct"),
                ...
                "lenient_norm_any_accuracy_on_matched_spans": lenient_norm.get("accuracy_on_matched_spans"),
                "lenient_norm_any_accuracy_on_comparable_gold_spans": lenient_norm.get("accuracy_on_comparable_gold_spans"),
                "lenient_norm_all_gold_ids_accuracy_on_matched_spans": lenient_norm.get("all_gold_ids_accuracy_on_matched_spans"),
                "lenient_norm_all_gold_ids_accuracy_on_comparable_gold_spans": lenient_norm.get("all_gold_ids_accuracy_on_comparable_gold_spans"),
